...
$employee_type = mysql_real_escape_string($_REQUEST["employee_type"]);
$supervisor = mysql_real_escape_string($_REQUEST["supervisor"]);
...
$status = isset($_REQUEST["isActive"]) ? mysql_real_escape_string($_REQUEST["isActive"])=="true" ? "ACTIVE" : "INACTIVE") : "ACTIVE";
