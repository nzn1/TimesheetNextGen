...
$results_per_page = Site::Config()->get('project_items_per_page');
...
//$qh_task_page = Site::Db()->sql($query_task_page,true, Database::TYPE_OBJECT);
...
<table class="simpleTable">
	...
	<tbody>
		<?php
	//execute query
	//$data_task = Site::Db()->newQuery($query_task);
