...
$data['task_id'] = mysql_real_escape_string($_REQUEST['task_id']);
$data['proj_id'] = mysql_real_escape_string($_REQUEST['proj_id']);
$client_id = mysql_real_escape_string($_REQUEST['client_id']);
$data['trans_num'] = mysql_real_escape_string($_REQUEST['trans_num']);
...
if ($action == "saveChanges") {
	...
	$data['log_message'] = mysql_real_escape_string($_REQUEST['log_message']);
	...
	$retval['status'] = Site::Db()->query($q);
	$retval['id'] = mysql_insert_id(Site::Db()->getConnection());
