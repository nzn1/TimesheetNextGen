<?php
// $Header: /cvsroot/tsheet/timesheet.php/admin_report_specific_user.php,v 1.11 2005/05/23 10:42:46 vexil Exp $ modified by ivan_nz 25/08/08
		...
		while ($data = dbResult($qh)) {
			...
			if ($last_proj_id != $data["proj_id"]) {
				...
				print "<tr><td valign=\"top\" colspan=\"4\" class=\"calendar_cell_disabled_right\">".
							"<a href=\"javascript:void(0)\" ONCLICK=window.open(\"proj_info.php?proj_id=$data[proj_id]\",\"Info\",\"location=0,directories=no,status=no,menubar=no,resizable=1,scrollbar=yes,width=500,height=200\") class=\"outer_table_action\">$current_project_title</a>\n";
							"</td></tr>\n";
				$total_time = 0;
			}
