...
?></td>
					...
					<td align="right" nowrap>
						<a href="proj_add.php?client_id=<?php echo $client_id;
...
<?php
		...
		?>
												...
												<td align="right" valign="top" nowrap>
													...
													<a href="proj_edit.php?client_id=<?php echo $client_id;

		?>&proj_id=<?php echo $data["proj_id"];

		?>">Edit</a>,
													<a href="javascript:delete_project(<?php echo $client_id;

		?>,<?php echo $data["proj_id"];

		?>);">Delete</a>
												</td>
											</tr>
											<tr>
												<td colspan="2"><?php echo $data["description"];

		?><br></td>
												<td valign="top" align="right"><span class="label">Client:</span> <?php echo $data["organisation"];
		...
		?>
															...
															<td width="30%">
																<div class="project_task_list">
																	<a href="task_maint.php?proj_id=<?php echo $data["proj_id"];
