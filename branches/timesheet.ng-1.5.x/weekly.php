									...
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="100%"><?php client_select_list( $client_id, $contextUser, false, false, true, false, "submit();" );
									...
									<td>
										<table width="100%" border="0" cellspacing="0" cellpadding="0">
											<tr>
												...
												<td width="100%"><?php project_select_list( $client_id, false, $proj_id, $contextUser, false, true, "submit();" );
...
for ( $i = 0; $i < 7; $i++ ){
	...
	$popup_href = "javascript:void(0)\" onclick=window.open(\"popup.php" . "?client_id=$client_id" . "&proj_id=$proj_id" . "&task_id=$task_id" . "&year=$currentYear" . "&month=$currentMonth" . "&day=$currentDay" . "&destination=$_SERVER[PHP_SELF]" . "\",\"Popup\",\"location=0,directories=no,status=no,menubar=no,resizable=1,width=420,height=310\") dummy=\"";
