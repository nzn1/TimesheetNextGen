				...
				<table width="100%" border="0" cellpadding="0" cellspacing="0" class="table_body">
					...
					<tr>
						...
						<td class="calendar_cell_disabled_right">
							<a href="admin_report_specific_user.php?month=<?php print $month;

?>&year=<?php print $year;

?>&mode=monthly">Generate monthly</a> /
							<a href="admin_report_specific_user.php?month=<?php print $month;

?>&year=<?php print $year;

?>&mode=weekly">Generate weekly</a>
						</td>
					<tr>
					<tr>
						<td class="calendar_cell_middle">Hours worked on specific project</td>
						<td class="calendar_cell_disabled_right">
							<a href="admin_report_specific_project.php?month=<?php print $month;
...
?>&mode=weekly">Generate weekly</a>
					...
					<tr>
						...
						<td class="calendar_cell_disabled_right">
							<a href="admin_report_specific_client.php?month=<?php print $month;
...
?>&mode=weekly">Generate weekly</a>
					...
					<tr>
						...
						<td class="calendar_cell_disabled_right">
							<a href="admin_report_all.php?month=<?php print $month;
