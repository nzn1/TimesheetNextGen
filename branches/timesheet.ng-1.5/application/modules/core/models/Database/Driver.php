...
abstract class Core_Database_Driver {
	...
	{
		throw new Core_Database_Exception('database.not_implemented', __FUNCTION__);
	}
	...
	protected function sql_type($str)
	{
		...
		{
			// Load SQL data types
			$sql_types = TSNG::config('core.sql_types.__ALL__');
		}
...
abstract class Database_Result implements ArrayAccess, Iterator, Countable {
	...
	{
		throw new Core_Database_Exception('database.result_read_only');
	}
