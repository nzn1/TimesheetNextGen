...
// var now defined in include/language/datetimepicker_lang.inc using language files
...
function RenderCssCal(bNewCal)
{
	...
	funcCalback += "} if(CalId.onchange===true) CalId.onchange(); Cal.OnDateSelected(CalId.value); winCal.style.visibility='hidden';}"; 
	// includes mods from http://groups.google.com/group/rainforestnet-javascript-date-time-picker/browse_thread/thread/c03e704c69b6b71c#
...
// PAL added to call a function to pass back the chosen date and update the window
