 ...
 */
class Core_Database_Mysql extends Core_Database_Driver {
	...
	public function list_fields($table)
	{
		...
		if (!isset($tables[$table]))
			throw new Core_Database_Exception('core.db_table_not_found', $table);
...
class Mysql_Result extends Database_Result {
	...
	public function __construct($result, $link, $object = TRUE, $sql)
	{
		...
		elseif (is_bool($result))
		{
			...
			{
				// SQL error
				throw new Core_Database_Exception('core.db_error', mysql_error($link).' - '.$sql);
			}
			else
			{
