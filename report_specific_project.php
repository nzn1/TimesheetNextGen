<?php
// $Header: /cvsroot/tsheet/timesheet.php/report_specific_project.php,v 1.10 2005/05/23 10:42:46 vexil Exp $ modified by ivan_nz 25/08/08
...
$print_popup_href = "javascript:void(0)\" onclick=window.open(\"print_report_specific_project.php".
						"?month=$month".
						"&year=$year".
						"&day=$day".
						"&client_id=$client_id".
