...
function buildLDAPUrlFromDb() {
	...
	var scheme = '<?php echo Site::Config()->get('LDAPScheme'); ?>';
	var host = '<?php echo Site::Config()->get('LDAPHost'); ?>';
	var port = '<?php echo Site::Config()->get('LDAPPort'); ?>';
	var baseDN = '<?php echo Site::Config()->get('LDAPBaseDN'); ?>';
	var usernameAttribute = '<?php echo Site::Config()->get('LDAPUsernameAttribute'); ?>';
	var searchScope = '<?php echo Site::Config()->get('LDAPSearchScope'); ?>';
	var filter = '<?php echo Site::Config()->get('LDAPFilter'); ?>';
...
?>
<body  onload="enableLDAP(<?php echo Site::Config()->get('useLDAP')?>);">
<div id="monthly">
	...
	<table  class="monthTable">
		...
		<tr>
			...
			<td align="left" width="100%">
				<input type="checkbox" name="useLDAPCheck" id="useLDAPCheck" onclick="enableLDAP(this.checked);"
					 <?php if (Site::Config()->get('useLDAP') == 1) echo "checked=\"checked\""; ?> /><?php echo JText::_('USE_LDAP'); ?>
					...
					<table width="100%" >
						...
						<tr>
							<td>
								...
								<option value="ldap" <?php if (Site::Config()->get('LDAPScheme') == "ldap") echo "selected=\"selected\"";?>>LDAP</option>
								<option value="ldaps" <?php if (Site::Config()->get('LDAPScheme') == "ldaps") echo "selected=\"selected\"";?>>LDAPS</option>
								</select>
						...
						<tr>
							<td width="50%">
								...
								<input id="LDAPHost" name="LDAPHost" type="text" value="<?php echo Site::Config()->get('LDAPHost'); ?>" style="width:100%;" />
							</div></td>
							</tr>
							<tr>
							<td width="50%">
								...
								<input id="LDAPPort" name="LDAPPort" type="text" size="10" maxlength="10" value="<?php echo Site::Config()->get('LDAPPort'); ?>" />
							</td>
						</tr>
						<tr>
							<td >
							...
							<td width="100%">
								<input id="LDAPBaseDN" type="text" name="LDAPBaseDN" value="<?php echo Site::Config()->get('LDAPBaseDN'); ?>" style="width:100%;" />
							</td>
						</tr>
						<tr>
							<td >
							...
							<td width="100%">
								<input id="LDAPUsernameAttribute" name="LDAPUsernameAttribute" type="text" value="<?php echo Site::Config()->get('LDAPUsernameAttribute'); ?>" size="30"/>
							</td>
						</tr>
						<tr>
							<td >
							...
							<td width="100%">
								<select id="LDAPSearchScope" name="LDAPSearchScope">
									<option value="base" <?php if (Site::Config()->get('LDAPSearchScope') == "base") echo "selected=\"selected\""; ?>>Base DN search only (LDAPRead)</option>
									<option value="one" <?php if (Site::Config()->get('LDAPSearchScope') == "one") echo "selected=\"selected\""; ?>>One level search (LDAPList)</option>
									<option value="sub" <?php if (Site::Config()->get('LDAPSearchScope') == "sub") echo "selected=\"selected\""; ?>>Full sub-tree search (LDAPSearch)</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td width="100%">
								<input id="LDAPFilter" type="text" name="LDAPFilter" value="<?php echo Site::Config()->get('LDAPFilter'); ?>" style="width:100%;" />
							</td>
						</tr>
						<tr>
							<td >
							...
							<td width="100%">
								<select id="LDAPProtocolVersion" name="LDAPProtocolVersion">
									<option value="3" <?php if (Site::Config()->get('LDAPProtocolVersion') == "3") echo "selected=\"selected\""; ?>>3</option>
									<option value="2" <?php if (Site::Config()->get('LDAPProtocolVersion') == "2") echo "selected=\"selected\""; ?>>2</option>
									<option value="1" <?php if (Site::Config()->get('LDAPProtocolVersion') == "1") echo "selected=\"selected\""; ?>>1</option>
								</select>
							</td>
						</tr>
						<tr>
							...
							<td width="100%">
								<input type="checkbox" name="LDAPReferralsCheck" id="LDAPReferralsCheck" <?php if (Site::Config()->get('LDAPReferrals') == 1 ) echo "checked=\"checked\""; ?> />
						...
						<tr>
							...
							<td width="100%">
								<input type="checkbox" name="LDAPFallbackCheck" id="LDAPFallbackCheck" <?php if (Site::Config()->get('LDAPFallback') == 1 ) echo "checked=\"checked\""; ?> />
						...
						<tr>
							...
							<td width="100%">
								<input type="checkbox" name="LDAPBindByUsercheck" id="LDAPBindByUsercheck" <?php if (Site::Config()->get('LDAPBindByUser') == 1) echo "checked=\"checked\""; ?> />
						...
						<tr>
							...
							<td width="50%">
								<input id="LDAPBindUsername" type="text" name="LDAPBindUsername" value="<?php echo Site::Config()->get('LDAPBindUsername'); ?>" style="width:100%;" />
							</td>
						</tr>
						<tr>
							<td >
							...
							<td width="50%">
								<input id="LDAPBindPassword" type="password" name="LDAPBindPassword" value="<?php echo Site::Config()->get('LDAPBindPassword'); ?>" style="width:100%;" AUTOCOMPLETE="OFF" />
							</td>
						</tr>
						<tr>
							<td >
		...
		<!-- ACL-->
			...
			<tr>
				...
				?>
					<tr><td><div><label><?php echo JText::_('STOPWATCH'); ?>:</label></td><td><?php Common::acl_select_droplist("aclStopwatch", Site::Config()->get('aclStopwatch')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('DAILY_TIMESHEET'); ?>:</label></td><td><?php Common::acl_select_droplist("aclDaily", Site::Config()->get('aclDaily')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('WEEKLY_TIMESHEET'); ?>:</label></td><td><?php Common::acl_select_droplist("aclWeekly", Site::Config()->get('aclWeekly')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('MONTHLY_TIMESHEET'); ?>:</label></td><td><?php Common::acl_select_droplist("aclMonthly", Site::Config()->get('aclMonthly')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('SIMPLE_WEEKLY_TIMESHEET'); ?>:</label></td><td><?php Common::acl_select_droplist("aclSimple", Site::Config()->get('aclSimple')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('CLIENTS'); ?>:</label></td><td><?php Common::acl_select_droplist("aclClients", Site::Config()->get('aclClients')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('PROJECTS'); ?>:</label></td><td><?php Common::acl_select_droplist("aclProjects", Site::Config()->get('aclProjects')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('TASKS'); ?>:</label></td><td><?php Common::acl_select_droplist("aclTasks", Site::Config()->get('aclTasks')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('REPORTS'); ?>:</label></td><td><?php Common::acl_select_droplist("aclReports", Site::Config()->get('aclReports')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('RATES'); ?>:</label></td><td><?php Common::acl_select_droplist("aclRates", Site::Config()->get('aclRates')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('ABSENCES'); ?>:</label></td><td><?php Common::acl_select_droplist("aclAbsences", Site::Config()->get('aclAbsences')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('EXPENSES'); ?>:</label></td><td><?php Common::acl_select_droplist("aclExpenses", Site::Config()->get('aclExpenses')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('EXPENSE_CATEGORIES_APPROVAL'); ?>:</label></td><td><?php Common::acl_select_droplist("aclECategories", Site::Config()->get('aclECategories')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('TIMESHEET_SUBMISSION'); ?>:</label></td><td><?php Common::acl_select_droplist("aclTsubmission", Site::Config()->get('aclTsubmission')); ?>&nbsp;</td></div></tr>
					<tr><td><div><label><?php echo JText::_('TIMESHEET_APPROVAL'); ?>:</label></td><td><?php Common::acl_select_droplist("aclTApproval", Site::Config()->get('aclTApproval')); ?>&nbsp;</td></div></tr>
		</table>
	</table>
	<table  class="monthTable">
			...
			<tr>
				...
				<td align="left" width="100%">
					<select name="simpleTimesheetLayout" id="simpleTimesheetLayout">
						<option value="small work description field" <?php if (Site::Config()->get('simpleTimesheetLayout') == 'small work description field') echo "selected=\"selected\"";?>>small work description field</option>
						<option value="big work description field" <?php if (Site::Config()->get('simpleTimesheetLayout') == 'big work description field') echo "selected=\"selected\"";?>>big work description field</option>
						<option value="no work description field" <?php if (Site::Config()->get('simpleTimesheetLayout') == 'no work description field') echo "selected=\"selected\"";?>>no work description field</option>
					</select>
				</td>
			</tr>
	...
	<table  class="monthTable">
			...
			<tr>
				...
				<td align="left" width="100%">
					<select name="startPage" id="startPage">
						<option value="stopwatch" <?php if (Site::Config()->get('startPage') == 'stopwatch') echo "selected=\"selected\"";?>>Stopwatch</option>
						<option value="daily" <?php     if (Site::Config()->get('startPage') == 'daily')     echo "selected=\"selected\"";?>>Daily Timesheet</option>
						<option value="weekly" <?php    if (Site::Config()->get('startPage') == 'weekly')    echo "selected=\"selected\"";?>>Weekly Timesheet</option>
						<option value="monthly" <?php   if (Site::Config()->get('startPage') == 'monthly')   echo "selected=\"selected\"";?>>Monthly View</option>
						<option value="simple" <?php    if (Site::Config()->get('startPage') == 'simple')    echo "selected=\"selected\"";?>>Simple Timesheet</option>
					</select>
				</td>
			</tr>
		...
		<!-- locale -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<input type="text" name="locale" size="75" maxlength="254" value="<?php echo htmlentities(trim(stripslashes(Site::Config()->get('locale')))); ?>" style="width: 100%;" />
				</td>
			</tr>
		...
		<!-- timezone -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<input type="text" name="timezone" size="75" maxlength="254" value="<?php echo htmlentities(trim(stripslashes(Site::Config()->get('timezone')))); ?>" style="width: 100%;" />
				</td>
			</tr>
			...
			<tr>
				...
				<td align="left" width="100%">
					<select name="timeformat" style="width: 100%;">
						<?php if (Site::Config()->get('timeformat') == "12") { ?>
					...
					<select name="weekstartday" style="width: 100%;">
						<?php
							...
							for ($i=0; $i<7; $i++) {
								...
								if (Site::Config()->get('weekstartday') == $i)
		...
		<!-- Items per page in Projects-->
			...
			<tr>
				...
				<td align="left" width="100%">
					<input type="text" name="projectItemsPerPage" size="75" maxlength="254" value="<?php echo htmlentities(trim(stripslashes(Site::Config()->get('project_items_per_page')))); ?>" style="width: 100%;" />
				</td>
			</tr>
		...
		<!-- Items per page in Tasks-->
			...
			<tr>
				...
				<td align="left" width="100%">
					<input type="text" name="taskItemsPerPage" size="75" maxlength="254" value="<?php echo htmlentities(trim(stripslashes(Site::Config()->get('task_items_per_page')))); ?>" style="width: 100%;" />
				</td>
			</tr>
		...
		<!-- headerhtml -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<textarea rows="5" cols="73" name="headerhtml" style="width: 100%;"><?php echo htmlentities(trim(stripslashes(Site::Config()->get('headerhtml')))); ?></textarea>
				</td>
			</tr>
		...
		<!-- bodyhtml -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<textarea rows="5" cols="73" name="bodyhtml"  style="width: 100%;"><?php echo htmlentities(trim(stripslashes(Site::Config()->get('bodyhtml')))); ?></textarea>
				</td>
			</tr>
		...
		<!-- bannerhtml -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<textarea rows="5" cols="73" name="bannerhtml" style="width: 100%;"><?php echo htmlentities(trim(stripslashes(Site::Config()->get('bannerhtml')))); ?></textarea>
				</td>
			</tr>
		...
		<!-- footerhtml -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<textarea rows="5" cols="73" name="footerhtml" style="width: 100%;"><?php echo htmlentities(trim(stripslashes(Site::Config()->get('footerhtml')))); ?></textarea>
				</td>
			</tr>
		...
		<!-- errorhtml -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<textarea rows="5" cols="73" name="errorhtml" style="width: 100%;"><?php echo htmlentities(trim(stripslashes(Site::Config()->get('errorhtml')))); ?></textarea>
				</td>
			</tr>
		...
		<!-- tablehtml -->
			...
			<tr>
				...
				<td align="left" width="100%">
					<textarea rows="5" cols="73" name="tablehtml" style="width: 100%;"><?php echo htmlentities(trim(stripslashes(Site::Config()->get('tablehtml')))); ?></textarea>
				</td>
			</tr>
